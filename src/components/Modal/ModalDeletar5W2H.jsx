...
function ModalDeletar5W2H({ cod5W2H, codProjeto, onClose }) {

    const [erro, setErro] = useState('');

    const delete5w2h = (cod5W2H, codProjeto) => {
        JX.deletar('AD_5W2HGERAL', [{ ID_ATIVIDADE: cod5W2H, ID: codProjeto }])
            .then(data => {
                if (data.status === "0") {
                    setErro(data.statusMessage)
                    alert('Erro ao excluir o 5W2H: ', erro)
                } else {
                    setErro('');
                ...
                <div className="relative p-4 w-full max-w-md max-h-full">
                    <div className="relative rounded-lg shadow bg-gray-700">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-400">Tem certeza que deseja excluir o registro?</h3>
                            <button
                                data-modal-hide="popup-modal"
                                type="button"
                                ...
                                onClick={() => delete5w2h(cod5W2H, codProjeto)}
                            >
                                Sim, excluir
                            </button>
                            <button
...
export default ModalDeletar5W2H;